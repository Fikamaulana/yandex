...
//━━━━━━━━━━━━━━━[ Terakhir ]━━━━━━━━━━━━━━━\\
			...
			const ownerNumber = [`6285279774918@s.whatsapp.net`] 
...
//━━━━━━━━━━━━━━━[ HARI HARI ]━━━━━━━━━━━━━━━\\
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			client.sendMessage(from, teks, text, { thumbnail: gember, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"TukulBot̻⁴̻⁰̻⁴̻",previewType:"PHOTO",thumbnail:gember,sourceUrl:`https://wa.me/p/6349482305092740/6285697662826`}}})
		}
		const reply2 = (teks) => {
...
//━━━━━━━━━━━━━━━[ FAKE FAKEAN ]━━━━━━━━━━━━━━━\\
           ...
           const fakedoc = {key: {fromMe: false, participant: `${nomorowner}@s.whatsapp.net`, ...(from ? {remoteJid: "status@broadcast" } : {}) }, message: {documentMessage: {mimetype: 'application/octet-stream', title: `${ucapanFakereply}`, pageCount: 0, fileName: `TukulBot̻⁴̻⁰̻⁴̻`, jpegThumbnail: fs.readFileSync(`./img/thumb.jpg`)}}}
...
const ftrolMENU = {key : {fromMe:false,
    ...
    client.sendMessage(from, buttonMessagesI, MessageType.buttonsMessage, {quoted: ftrol, sendEphemeral: true, contextInfo:{"forwardingScore":999,"isForwarded":true, "externalAdReply":{"title": `${namabot}`, "body": `Simple Bot`, mediaType: 2, "thumbnail": fs.readFileSync('./img/TukulBot.jpg'),"previewType": `https://youtube.com/channel/UCR_Jax0-liRMgZ_-Lm0IbHw`,"mediaUrl": `https://youtube.com/channel/UCR_Jax0-liRMgZ_-Lm0IbHw`}}})
  }
...
return [...text.matchAll(/@([0-9]{5,16}|0)/g)].map(v => v[1] + '@s.whatsapp.net')
			...
			function addMetadata(packname, author) {	
				if (!packname) packname = 'Gweh'; if (!author) author = 'TukulBot';	
...
const froxx = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `TukulBot̻⁴̻⁰̻⁴̻`,
                 "title": `TukulBot̻⁴̻⁰̻⁴̻`,
                 'jpegThumbnail': fs.readFileSync("./img/TukulBot.jpg"),
                        }
	                  } 
                     }
//━━━━━━━━━━━━━━━[ JAM ]━━━━━━━━━━━━━━━\\
...
➪ 𝑵𝒐𝒎𝒐𝒓 𝑶𝒘𝒏𝒆𝒓 : wa.me/6285279774918

☏ 𝑺𝒐𝒔𝒊𝒂𝒍 𝑴𝒆𝒅𝒊𝒂 𝑶𝒘𝒏𝒆𝒓 ☏︎
➪ 𝒀𝒐𝒖𝑻𝒖𝒃𝒆 : MyTukulBot
➪ 𝑭𝒂𝒄𝒆𝒃𝒐𝒐𝒌 : Ga Ada
➪ 𝑮𝒊𝒕𝒉𝒖𝒃 : https://github.com/zakygz66/`

ply2 =`MyTukulBot, ${tanggal} ${bulan} ${tahun}`
but = [
...
ply2 =`BOT MASIH DALAM UJI COBA,JIKA ADA FITUR YANG EROR SEGERA HUBUNGI OWNER YA`
but = [
...
case 'scrip':
if (isBanned) return reply(mess.banned)
reply2(`JANGAN LUPA SUBSCRIBE YouTube : MyTukulBot`)
break
//══════════[ ASUPAN MENU ]════════════════════════════//
             case 'asupangeayubi':
             if (isBanned) return reply(mess.banned)
             ...
             videoMsg = (await client.prepareMessageMedia(naura, "videoMessage", { thumbnail: naura, })).videoMessage
              ...
              break
              case 'emoji':
              if (!q) return fakestatus(`mana emoji nya njing`)
...
//══════════[ANIME MENU]════════════════════════════//
            ...
            if (isBanned) return reply(mess.banned)
              ...
              contentText:`Creator TukulBot404`,buttons,headerType:4}
...
case 'ph':
if (isBanned) return reply(mess.banned)
if (args.length < 1) return reply(`Nama yang mau di tulis?\nContoh: ${prefix + command} TukulBot|404`)
reply(mess.wait)
hh = arg.split('|')[0]
hj = arg.split('|')[1]
...
await client.sendMessage(from, anu1, image, {caption: '.sticker', quotes: mek})
} else {
...
break
           ...
           if (isBanned) return reply(mess.banned)
                    ...
                    client.sendMessage(from, anu1, image, {caption: `.sticker`, quoted: mek})
                    break
          case 'attp':
          if (isBanned) return reply(mess.banned)
...
buffer = await getBuffer(`https://zynfx.herokuapp.com/api/canvas/gfx1?teks=${q}`)
...
ha = arg.split('|')[0]
ho = arg.split('|')[1]
buff = await getBuffer(`https://zynfx.herokuapp.com/api/canvas/gfx3?teks1=${ha}&teks2=${ho}`)
client.sendMessage(from, buff, image, {caption: `Nih Bwangg`, quoted: mek})
break
case 'gura':
if (!c) return reply(`hmm`)
bupp = await getBuffer(`https://zynfx.herokuapp.com/api/canvas/gura?teks=${c}`)
